...
public class GameTest {
	...
	public void inicializaJogadores() {
		...
		p1.takeCard(new Card(Rank.FOUR));
		p1.takeCard(new Card(Rank.FIVE));
		p1.takeCard(new Card(Rank.SIX));
		
		
		p2.takeCard(new Card(Rank.FIVE));
		p2.takeCard(new Card(Rank.FOUR));	
		p2.takeCard(new Card(Rank.SEVEN));		
	}
